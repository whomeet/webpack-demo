! function (t) {
    ...
    e = t.exports = n(3)(!1), e.push([t.i, "body{background-color:blue}", ""])
}, function (t, e) {
    function n(t, e) {
        var n = t[1] || "",
            o = t[3];
    ...
    function r(t, e) {
        for (var n = 0; n < t.length; n++) {
            ...
            if (o) {
                ...
                for (var s = [], i = 0; i < r.parts.length; i++) s.push(f(r.parts[i], e));
                h[r.id] = {
                    id: r.id,
                    refs: 1,
                    parts: s
    ...
    function f(t, e) {
        ...
        if (e.singleton) {
            var c = y++;
            n = m || (m = a(e)), r = l.bind(null, n, c, !1), o = l.bind(null, n, c, !0)
